...
🎓 **Honours Computer Science Student** focused on full-stack web development, systems programming, and ethical hacking.  
💻 **Project-Driven Developer** who enjoys building real-world apps like **MindScape**, crypto dashboards, and portfolio websites.  
🔐 Passionate about **security**, **clean code**, and **efficient systems**.  
☁️ Currently diving into **cloud infrastructure**, **parallel computing**, and **AI-based tools**.
